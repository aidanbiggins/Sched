                  ...
                  <button
                    onClick={() => {
                      const event: CalendarEventData = {
                        title: `Interview - ${data?.request?.reqTitle || 'Interview'}`,
                        description: `Interview for ${data?.request?.reqTitle || 'position'}`,
                        startTime: new Date(scheduledStart),
                        endTime: new Date(scheduledEnd),
                        timezone: timezone,
                        organizerEmail: interviewerEmail || 'noreply@sched.app',
                        conferenceUrl: joinUrl,
                      };
